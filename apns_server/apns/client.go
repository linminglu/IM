...
func (client *Client) Connect() error {
	...
	if len(client.CertificateBase64) == 0 && len(client.KeyBase64) == 0 {
		...
		fmt.Println("client.CertificateFile:", client.CertificateFile , "client.KeyFile:", client.KeyFile, "cert:", cert)
	} else {
	...
	client.tlsConn = tls.Client(conn, conf)
